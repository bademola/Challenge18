...
class Block:
    ...
    record: Record  ##changing the any to Record
...
# YOUR CODE HERE
receiver_data = str(st.text_area("Enter receiver Address")).encode()

# @TODO:
# Add an input area where you can get a value for `amount` from the user.
amount_data = str(st.text_area("Enter amount for user")).encode()
...
if st.button("Add Block"):
    ...
    new_block = Block(
        ...
        #data= Record, #changed from input data to RECORD
        creator_id= 42,
